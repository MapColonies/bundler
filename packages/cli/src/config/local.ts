...
const LOCAL_DIR = `${homedir()}/.bundler-cli`;
const DEFAULT_WORKDIR = `${LOCAL_DIR}/workdir`;
const DEFAULT_CONFIG_PATH = `${LOCAL_DIR}/config.json`;
...
export const LOGS_DIR = `${LOCAL_DIR}/logs`;
